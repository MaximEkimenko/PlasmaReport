...
from utils.excel_utils import create_excel_async
from sigma_handlers.sigma_db import get_sigma_data_async
...
@router.get("/get_raw_data", tags=["logist"])
async def get_raw_data(
    ...
    """
    return await get_sigma_data_async(start_date=start_date, end_date=end_date)
